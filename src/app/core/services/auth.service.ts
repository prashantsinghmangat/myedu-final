...
export class AuthService {
  ...
  login(payload: any): Observable<any> {
    return this.http.post(`${environment.myEduBaseUrl}/login`, payload);
  }

  signup(payload: any): Observable<any> {
    return this.http.post(`${environment.myEduBaseUrl}/register`, payload);
  }

  verifyOtp(payload: any): Observable<any> {
    return this.http.post(`${environment.myEduBaseUrl}/verifyOtp`, payload);
  }
